...
let SmoothScroll = require('./plugins/smooth-scroll.min');
let Instafeed = require('./plugins/instafeed.min');
...
let scroll = new SmoothScroll('a.smooth-scroll', {
    // Selectors
...
$(document).ready(function () {
    ...
    function toggleH() {
        $('.toggleCaption').hide()
        let caption = carouselContainer.find('.active').find('.toggleCaption').addClass('animated fadeInRight').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend',
    ...
    function toggleC() {
        $('.toggleButton').hide()
        let button = carouselContainer.find('.active').find('.toggleButton').addClass('animated fadeInUp').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend',
