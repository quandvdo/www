...
@section('content')
                        ...
                        <a class=""
                           ...
                           target="_blank">
                            <div class="destination-item">
                                ...
                                <h6 class="white front">{{$city->city}} Tours</h6>
                            </div>
                        </a>
                    </div>
                @endforeach
    ...
    <section id="section3">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-sm-9 front">
                    <div class="separator "></div>
                    <h5 class="primary-color section-title ">Best &amp; Most Popular Tours</h5>
                </div>
                <div class="col-sm-3 front my-auto">
                    ...
                    @foreach($packages as  $key=>$package)
                        <div
                            ...
                            <div class="card">
                                ...
                                <a class="img-card" href="{{route('package.detail', ['slug' => $package->slug])}}">
                                    <img src="https://picsum.photos/360/200?image={{rand(1,1000)}}" alt="image"/>
                                </a>
                                <div class="card-content">
                                    <div>
                                    ...
                                    <h6 class="primary-color text-right">
                                        ${{number_format($package->price->price,2)}}</h6>
                                    <h6 class="black"><a href="{{route('package.detail', ['slug' => $package->slug])}}"
                                                         target="_blank">{{$package->title}}</a></h6>
                                    <p>
                                        {{$package->description}}
                                    </p>
                                    <p>
                                        <a href="{{route('package.detail', ['slug' => $package->slug])}}"
                                           target="_blank" class="btn btn-link">See more</a>
                                    </p>
                                </div>
                            </div>
    ...
    <section id="section5">
        <img class="curve4" src="{{asset('svg/curve.svg')}}" alt="imageSectionDivider">
        <div class="container">
        ...
        <div class="chapter2">
            <img class="curve4" src="{{asset('svg/curve.svg')}}" alt="image">
        </div>
    </section>
    <!-- End section 3 tours-->
    <section id="section4">
