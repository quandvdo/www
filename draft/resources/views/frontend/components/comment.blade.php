...
<div class="mt-5  mx-auto my-auto">
            ...
            <div class="row mt-3">
                <div class="col-12 ">
                    <div class="form-group text-center">
                        <label for="comment_body">Your thoughts about this
                            blog...</label>
    ...
    @else
        <div class="text-center">
            <label for="comment_body" class="form-control">Login to leave a comment</label>
            <a href="{{route('login')}}" class="btn mt-2 btn-primary">Login Here</a>
        </div>
    @endif
</div>