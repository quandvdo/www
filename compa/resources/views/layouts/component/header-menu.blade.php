<div class="main-header">
    ...
    <div class="header-part-right">
        ...
        <!-- Notificaiton -->
        <div class="dropdown">
            <div class="badge-top-container" id="dropdownNotification" data-toggle="dropdown" aria-haspopup="true"
                 aria-expanded="false">
        ...
        <div class="dropdown">
            <div class="user col align-self-end">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    ...
                    --}}
                    <a href="{{route('users.index', ['id' => Auth::user()->id ])}}" class="dropdown-item">My profile</a>
