...
@section('main-content')
    <div class="breadcrumb">
        ...
        <ul>
            ...
            <li>{{Auth::user()->name}} <span class="badge badge-warning">{{Auth::user()->roles[0]->display_name}}</span>
            </li>
        </ul>
    ...
    <div class="card user-profile o-hidden mb-4">
        ...
        <div class="user-info">
            ...
            <p class="text-muted m-0">{{Auth::user()->roles[0]->display_name}}</p>
        </div>
        <div class="card-body">
            ...
            <div class="tab-content" id="profileTabContent">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="button" id="button-comment1">Submit
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="timeline-card card">
                                <div class="card-body">
                                    ...
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi dicta beatae illo
                                        ...
                                        architecto aspernatur enim iure debitis dignissimos suscipit
                                        ipsa.
                                    </p>
                                    <div class="mb-3">
                                        <a href="#" class="mr-1">Like</a>
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Write comment"
                                               aria-label="comment">
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="button" id="button-comment2">Submit
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Write comment"
                                               aria-label="comment">
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="button" id="button-comment3">Submit
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Write comment"
                                               aria-label="comment">
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="button" id="button-comment4">Submit
                                            </button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade" id="about" role="tabpanel" aria-labelledby="about-tab">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, commodi quam! Provident quis
                ...
                <div class="tab-pane fade" id="photos" role="tabpanel" aria-labelledby="photos-tab">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card text-white o-hidden mb-3">
                                <img class="card-img" src="assets/images/products/headphone-2.jpg" alt="">
                                <div class="card-img-overlay">
                                    <div class="p-1 text-left card-footer font-weight-light d-flex">
                                                <span class="mr-3 d-flex align-items-center"><i
                                                            class="i-Speach-Bubble-6 mr-1"></i>
                        ...
                        <div class="col-md-4">
                            <div class="card text-white o-hidden mb-3">
                                <img class="card-img" src="assets/images/products/headphone-3.jpg" alt="">
                                <div class="card-img-overlay">
                                    <div class="p-1 text-left card-footer font-weight-light d-flex">
                                                <span class="mr-3 d-flex align-items-center"><i
                                                            class="i-Speach-Bubble-6 mr-1"></i>
                        ...
                        <div class="col-md-4">
                            <div class="card text-white o-hidden mb-3">
                                <img class="card-img" src="assets/images/products/iphone-1.jpg" alt="">
                                <div class="card-img-overlay">
                                    <div class="p-1 text-left card-footer font-weight-light d-flex">
                                                <span class="mr-3 d-flex align-items-center"><i
                                                            class="i-Speach-Bubble-6 mr-1"></i>
                        ...
                        <div class="col-md-4">
                            <div class="card text-white o-hidden mb-3">
                                <img class="card-img" src="assets/images/products/iphone-2.jpg" alt="">
                                <div class="card-img-overlay">
                                    <div class="p-1 text-left card-footer font-weight-light d-flex">
                                                <span class="mr-3 d-flex align-items-center"><i
                                                            class="i-Speach-Bubble-6 mr-1"></i>
                        ...
                        <div class="col-md-4">
                            <div class="card text-white o-hidden mb-3">
                                <img class="card-img" src="assets/images/products/watch-1.jpg" alt="">
                                <div class="card-img-overlay">
                                    <div class="p-1 text-left card-footer font-weight-light d-flex">
                                                <span class="mr-3 d-flex align-items-center"><i
                                                            class="i-Speach-Bubble-6 mr-1"></i>
